...
@section('page-ttile', 'Listing Request Status - Smith Realty')
        ...
        @for ($i = 0; $i < 10; $i++)
            <div class="request-list__wrapper">
                <div>
                    ...
                    <span class="request-list__details"><i class="fa-solid fa-bed"></i> 4 <i class="fa-solid fa-bath"></i> 3 <i class="fa-solid fa-ruler-combined"></i> 2,240 SQFT</span>
                </div>
